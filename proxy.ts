...
const isPublicRoute = createRouteMatcher(['/', '/api/request', '/api/dropdown-data', '/api/grow/stats', '/api/grow/upcoming-meetings', '/api/grow/migrate-data', '/api/grow/seed-data']);
