...
// the operational note (e.g. "Claybourne Co. FL launch. Confirmed per ...
// 🎓 Education Only — No Sampling: ..."). Only the marker onward is meant
// for ambassadors/admins, so trim to that.
