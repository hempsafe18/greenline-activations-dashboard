      ...
      <div className="main">
        ...
        <div className={`section ${activeSection === 'intel' ? 'active' : ''}`}>
          <div className="card">
            ...
            <div className="intel-item"><span className="intel-icon">🍊</span><p className="intel-text"><strong>Juicy Grapefruit dominates.</strong> Top sampled and purchased SKU across all locations.</p></div>
          </div>
        </div>
